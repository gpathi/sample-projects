...
include_once 'highwire_rollout.helper.inc';
        ...
        // Update the configuration of article tab mini panel
	     if ($mini->name == $minipanel){
			   ...
			   foreach ($mini->display->content as $contentObj)  {
					 ...
					 if ($contentObj->type == 'highwire_markup') {
						
					    $contentObj->configuration['process']['highwire_google_scholar'] = 'highwire_google_scholar';
            ...
            foreach ($pages as &$page) {
                     if ($page && (substr($page->name,0,9) == 'node_view')) {
                           ...
                           foreach ( $display->content as $contentobj ) {
                                 ...
                                 if ($contentobj->type == "highwire_panel_tabs") { // highwire_panel_tabs
